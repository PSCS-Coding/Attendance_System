<!DOCTYPE html>
    <html>
	 ...
	 <div align="center">
	    <h1>Welcome Admin!</h1>
            <button type="button" id="button1">Edit Students</button>
	    <button type="button" id="button2">Edit Facilitators</button>
	    <button type="button" id="button3">Edit Allotted Hours</button>
	    <button type="button" id="button4">Edit Passwords</button>
	    <button type="button" id="button5">Edit Holidays</button>
	    <button type="button" id="button6">Edit Globals</button>
