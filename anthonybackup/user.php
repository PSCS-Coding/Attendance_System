...
<form method='post' action='<?php echo basename($_SERVER['PHP_SELF']); ?>' id='main'>
	...
	<div>
		<input class = checkbox type="checkbox" name="favorite">
		<p> Do this now, and also save this to favorites </p>
	</div>
	...
	?>
		<?php
	$yolofully = "<marquee behavior='scroll' direction='left'>";
	$yolofully2 = "</marquee>";
	...
	<!--	<button type="submit" name="<?php echo $postfav ?>" form="main"><marquee behavior='scroll' direction='left'><?php echo $fullstring ?></marquee></button> -->
	...
	?>
		...
		<div>
		<input class = checkbox type="checkbox" name="otherdate">
		<p>Don't do this now, but make this take effect at this future date: </p>
		</div>
